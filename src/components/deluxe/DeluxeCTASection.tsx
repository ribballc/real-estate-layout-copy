            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a href={slug ? `/site/${slug}/book` : "#contact"} className="book-now-link">
                  <button className="bg-[hsl(0,0%,4%)] text-white px-8 py-4 rounded-full text-[15px] font-semibold flex items-center gap-2.5 group hover:bg-[hsl(0,0%,15%)] hover:shadow-[0_8px_30px_-6px_rgba(0,0,0,0.3)] transition-all duration-300">
                    Book Now
