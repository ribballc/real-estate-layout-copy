...
const reviews = [
  ...
  { initials: "SL", name: "Sarah Langston", role: "Luxe Auto Care", quote: "As a solo operator this was exactly what I needed — like having a receptionist and web developer for $54/mo. Customers tell me the booking page is so clean.", metric: "+$2,200/mo" },
