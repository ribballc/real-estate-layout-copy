  ...
  return (
    <FadeIn delay={index * 80}>
      <div
        ...
        style={{
          background: open ? "hsla(217, 71%, 53%, 0.1)" : "hsla(0, 0%, 100%, 0.06)",
          border: open ? "1px solid hsla(217, 71%, 53%, 0.3)" : "1px solid hsla(0, 0%, 100%, 0.1)",
          boxShadow: open ? "0 8px 32px hsla(217, 71%, 53%, 0.12)" : "0 2px 8px hsla(0, 0%, 0%, 0.1)",
        }}
      >
        <button
        ...
        >
          ...
          <div
            ...
            style={{
              background: open ? "hsla(217, 71%, 53%, 0.2)" : "hsla(0, 0%, 100%, 0.08)",
              transform: open ? "rotate(180deg)" : "rotate(0deg)",
            }}
          >
            <ChevronDown className="w-4 h-4" style={{ color: open ? "hsl(213, 94%, 68%)" : "hsla(0, 0%, 100%, 0.5)" }} />
          </div>
        </button>
        <div
        ...
        >
          <p className="px-6 md:px-8 pb-6 md:pb-8 leading-relaxed text-[15px] md:text-base" style={{ color: "hsla(0, 0%, 100%, 0.55)" }}>
            {answer}
          </p>
        </div>
      </div>
    ...
    >
      <div className="max-w-3xl mx-auto relative z-10">
        <FadeIn>
          ...
          <p className="text-base md:text-lg text-center max-w-xl mx-auto mb-12 md:mb-16 leading-relaxed" style={{ color: "hsla(0, 0%, 100%, 0.55)" }}>
