    ...
    <div className="min-h-screen relative flex items-center justify-center px-4 py-12">
      ...
      <FadeIn>
        ...
        >
          ...
          {/* Heading */}
          <h1 className="text-center text-white font-bold text-2xl mb-1">Welcome back</h1>
          ...
          <p className="text-center mt-5" style={{ fontSize: 14, color: "hsla(0,0%,100%,0.5)" }}>
            ...
            <Link to="/signup" className="font-medium hover:underline" style={{ color: "hsl(217,91%,60%)" }}>
              Sign up
            </Link>
          </p>
        </div>
