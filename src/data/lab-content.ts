...
import {
  ...
  Cog, Clock, UserPlus, MessageSquare, Zap,
        ...
        lessons: [
          {
            ...
            outcome: "Convert 65-80% of new customers into monthly subscribers.",
            estimatedMinutes: 15,
            icon: Target,
            sections: [
              {
              ...
              },
              {
                ...
                template: "[BUSINESS_NAME]: First detail 50% off + monthly membership! $[HALF_PRICE] first visit, then $[MONTHLY_PRICE]/mo. Book: [LINK]",
          ...
          },
          {
            ...
            outcome: "Increase average order value by 40% with tiered monthly plans.",
            estimatedMinutes: 20,
            icon: Layers,
            sections: [
              {
        ...
        lessons: [
          {
            ...
            nextLessons: ["time-blocking", "customer-communication"],
          },
          {
            id: "time-blocking",
            title: "Time Blocking for Max Revenue Days",
            type: "lesson",
            level: "intermediate",
            tags: ["Operations", "Scheduling", "Productivity"],
            outcome: "Fit 1-2 more jobs per day without working longer hours.",
            estimatedMinutes: 15,
            icon: Clock,
            sections: [
              {
                heading: "The Concept",
                body: "Most detailers lose 2-3 hours per day to travel, gaps between appointments, and unstructured days. Time blocking fixes this by batching your work into zones.",
              },
              {
                heading: "The Ideal Day Structure",
                body: "**6:00-7:00 AM** — Travel to first job, setup\n**7:00-11:00 AM** — Morning block: 1-2 full details\n**11:00-11:30 AM** — Travel/lunch\n**11:30 AM-3:30 PM** — Afternoon block: 1-2 details\n**3:30-4:00 PM** — Cleanup, drive home\n**4:00-4:30 PM** — Admin: respond to messages, send follow-ups\n\n**Key rules:**\n→ Group jobs by area (north side mornings, south side afternoons)\n→ Block 30-min buffers between jobs\n→ Keep Sundays free or use for catch-up",
              },
              {
                heading: "Set Up Your Calendar",
                body: "Use our calendar tool to block your available hours. Only allow bookings during your working blocks — no more random 2pm Tuesday appointments that break your flow.",
              },
            ],
            actionLink: "/dashboard/calendar",
            actionLabel: "Set up my calendar blocks",
            nextLessons: ["no-show-prevention", "hiring-first-tech"],
          },
          {
            ...
            type: "script",
            level: "beginner",
            tags: ["Operations", "Communication", "Scripts"],
            outcome: "Handle every customer interaction professionally and consistently.",
            estimatedMinutes: 10,
            icon: MessageSquare,
            sections: [
              {
                heading: "New Inquiry Response",
                body: "Reply within 5 minutes for 10x higher conversion:",
                template: "Hey [NAME]! Thanks for reaching out to [BUSINESS]. I'd love to get your car looking amazing.\n\nA few quick questions:\n1. What's the year/make/model?\n2. What service are you interested in?\n3. When works best for you?\n\nOr you can book directly here: [BOOKING_LINK]\n\n— [YOUR_NAME]",
                templateLabel: "Copy Inquiry Response",
              },
              {
                heading: "Post-Service Follow-Up",
                body: "Send 2 hours after completing the job:",
                template: "Hey [NAME]! Your [SERVICE] is all done 🔥 A few things to keep your car looking fresh:\n\n• Avoid washing for 48 hours (coating needs to cure)\n• Use the shade when parking if possible\n• Avoid automatic car washes\n\nEnjoy that new car feeling! If you love the results, a Google review means the world: [REVIEW_LINK]\n\n— [YOUR_NAME]",
                templateLabel: "Copy Follow-Up",
              },
              {
                heading: "Handling Price Objections",
                body: "When someone says \"that's too expensive\":",
                template: "I totally understand — quality detailing is an investment. Here's what makes us different:\n\n✓ We use premium products that last 3-6x longer\n✓ Every detail includes [UNIQUE_VALUE]\n✓ 100% satisfaction guaranteed\n\nI also have a monthly membership that brings the per-detail cost down significantly. Want me to send the details?\n\n[BOOKING_LINK]",
                templateLabel: "Copy Price Response",
              },
            ],
            nextLessons: ["no-show-prevention", "review-generation"],
          },
        ],
      },
      {
        ...
        lessons: [
          {
            ...
            nextLessons: ["time-blocking", "kpi-dashboard"],
          },
        ],
      },
    ],
            ...
            sections: [
              {
                ...
                body: "After every job, run this 3-touch sequence:\n\n1. **Day 0** — Post-service thank you + review request\n2. **Day 30** — \"Your car might be ready for a refresh\" reminder\n3. **Day 60** — Special comeback offer if they haven't booked",
              },
              {
              ...
              {
                heading: "Day 30: Refresh Reminder",
                body: "Automated 30 days later:",
                template: "Hey [NAME]! It's been about a month since your last detail. Your car might be ready for a refresh 🧽 Book your next one and keep it looking showroom-fresh: [BOOKING_LINK]\n\n— [BUSINESS]",
                templateLabel: "Copy Day-30 Text",
              },
              {
                heading: "Day 60: Comeback Offer",
                body: "If they haven't booked by day 60:",
                template: "Hey [NAME], we miss your car! 😄 Here's 15% off your next detail — just because. Use code COMEBACK at checkout: [BOOKING_LINK]\n\nOffer expires in 7 days.\n\n— [BUSINESS]",
                templateLabel: "Copy Day-60 Text",
              },
            ],
    ...
    modules: [
      {
        ...
        lessons: [
          ...
          },
          {
            ...
            nextLessons: ["hourly-rate-calc", "time-blocking"],
          },
        ],
      },
      {
